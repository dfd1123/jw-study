...
(function (global, factory) {
  ...
  var animates = {
    pulling: function pulling(d, opts) {
      if (!opts.elControl)
        opts.elControl = opts.container.querySelector(
          ".pull-to-refresh-material__control"
        );

      var threshold = opts.threshold;
      var elControl = opts.elControl;
      ...
      elControl.style.transform = y
        ? "translate3d(-50%, " + y + "px, 0) rotate(" + 360 * p + "deg)"
        : "";
    },
    refreshing: function refreshing(_ref) {
      ...
      elControl.style.transform = "translate3d(-50%, " + threshold + "px, 0)";
    },
